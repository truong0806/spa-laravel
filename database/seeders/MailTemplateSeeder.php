...
class MailTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $template->defaultMailTemplateMap()->create([
            ...
            'template_detail' => '<p>Hello [[ provider_name ]],</p>
                                  <p>Your payout of [[ amount ]] has been processed.</p>
                                  <p>&nbsp;</p>
                                  <p>Best regards,<br />[[ company_name ]]</p>',
        ]);
        ...
        $template->defaultMailTemplateMap()->create([
            ...
            'subject' => 'New User Registration',
            'template_detail' => '<p>Hello [[ provider_name ]],</p>
                                  <p>Cảm ơn bạn đã đăng ký với Spa Online. Chúng tôi đã nhận được yêu cầu đăng ký của bạn và sẽ sớm xem xét thông tin của bạn. Bạn sẽ nhận được email có hướng dẫn thêm sau khi đăng ký của bạn được chấp thuận.</p>
                                  <p>&nbsp;</p>
                                  <p>Best regards,<br />[[ company_name ]]</p>',
        ]);
        $template->defaultMailTemplateMap()->create([
            ...
            'subject' => 'New User Registration',
            'template_detail' => '<p>Hello [[ handyman_name ]],&nbsp;</p>
                                  <p>Cảm ơn bạn đã đăng ký với Spa Online.&nbsp;</p>
                                  <p>Chúng tôi đã nhận được yêu cầu đăng ký của bạn và sẽ sớm xem xét thông tin của bạn. Bạn sẽ nhận được email có hướng dẫn thêm sau khi đăng ký của bạn được chấp thuận.</p>
                                  <p>&nbsp;</p>
                                  <p>Best regards,<br />[[ company_name ]]</p>',
        ]);
        $template->defaultMailTemplateMap()->create([
