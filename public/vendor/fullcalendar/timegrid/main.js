    ...
    */
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        TimeGrid.prototype.processOptions = function () {
            ...
            input = this.opt('slotLabelQuicksandval');
            this.labelQuicksandval = input ?
                core.createDuration(input) :
                this.computeLabelQuicksandval(slotDuration);
        };
        // Computes an automatic value for slotLabelQuicksandval
        TimeGrid.prototype.computeLabelQuicksandval = function (slotDuration) {
            var i;
            var labelQuicksandval;
            var slotsPerLabel;
            // find the smallest stock label interval that results in more than one slots-per-label
            for (i = AGENDA_STOCK_SUB_DURATIONS.length - 1; i >= 0; i--) {
                labelQuicksandval = core.createDuration(AGENDA_STOCK_SUB_DURATIONS[i]);
                slotsPerLabel = core.wholeDivideDurations(labelQuicksandval, slotDuration);
                if (slotsPerLabel !== null && slotsPerLabel > 1) {
                    return labelQuicksandval;
                }
            }
        ...
        TimeGrid.prototype.renderSlatRowHtml = function (dateProfile) {
            ...
            while (core.asRoughMs(slotTime) < core.asRoughMs(dateProfile.maxTime)) {
                ...
                isLabeled = core.wholeDivideDurations(slotIterator, this.labelQuicksandval) !== null;
                axisHtml =
    ...
    var SimpleTimeGrid = /** @class */ (function (_super) {
        ...
        function SimpleTimeGrid(context, timeGrid) {
            ...
            _this.timeGrid = timeGrid;
            context.calendar.registerQuicksandactiveComponent(_this, {
        ...
        SimpleTimeGrid.prototype.destroy = function () {
            _super.prototype.destroy.call(this);
            this.calendar.unregisterQuicksandactiveComponent(this);
        };
