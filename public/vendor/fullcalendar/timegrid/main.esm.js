...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.computeLabelQuicksandval = function (slotDuration) {
        ...
        for (i = AGENDA_STOCK_SUB_DURATIONS.length - 1; i >= 0; i--) {
            labelQuicksandval = createDuration(AGENDA_STOCK_SUB_DURATIONS[i]);
            slotsPerLabel = wholeDivideDurations(labelQuicksandval, slotDuration);
    ...
    TimeGrid.prototype.renderSlatRowHtml = function (dateProfile) {
        ...
        while (asRoughMs(slotTime) < asRoughMs(dateProfile.maxTime)) {
            ...
            isLabeled = wholeDivideDurations(slotIterator, this.labelQuicksandval) !== null;
            axisHtml =
