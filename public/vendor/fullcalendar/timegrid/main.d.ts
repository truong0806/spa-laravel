...
declare module '@fullcalendar/timegrid/TimeGrid' {
    import { PositionCache, Duration, DateMarker, DateFormatter, ComponentContext, DateComponent, Seg, EventSegUiQuicksandactionState, DateProfile } from '@fullcalendar/core';
    ...
    class TimeGrid extends DateComponent<TimeGridProps> {
        ...
        processOptions(): void;
        computeLabelQuicksandval(slotDuration: any): any;
        ...
        _renderEventDrag(state: EventSegUiQuicksandactionState): void;
        _unrenderEventDrag(state: EventSegUiQuicksandactionState): void;
        _renderEventResize(state: EventSegUiQuicksandactionState): void;
        _unrenderEventResize(state: EventSegUiQuicksandactionState): void;
...
declare module '@fullcalendar/timegrid/SimpleTimeGrid' {
    import { DateComponent, DateProfile, EventStore, EventUiHash, EventQuicksandactionState, DateSpan, DateRange, DayTable, DateEnv, DateMarker, Slicer, Hit, ComponentContext } from '@fullcalendar/core';
