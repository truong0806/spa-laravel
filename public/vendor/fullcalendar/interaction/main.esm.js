...
var FeaturefulElementDragging = /** @class */ (function (_super) {
    ...
    function FeaturefulElementDragging(containerEl) {
        ...
        _this.isQuicksandacting = false; // is the user validly moving the pointer? lasts until pointerup
        ...
        _this.onPointerMove = function (ev) {
            if (_this.isQuicksandacting) { // if false, still waiting for previous drag's revert
            ...
            if (hit) {
                ...
                if (initialCalendar === receivingCalendar ||
                    ...
                    if (mutation) {
                        ...
                        if (!receivingComponent.isQuicksandactionValid(interaction)) {
                            isInvalid = true;
                            mutation = null;
    ...
    function EventDragging(settings) {
        ...
        _this.handleHitUpdate = function (hit, isFinal, ev) {
            ...
            if (mutation) {
                ...
                interaction.mutatedEvents = mutatedRelevantEvents;
                if (!_this.component.isQuicksandactionValid(interaction)) {
                    isInvalid = true;
                    mutation = null;
                    mutatedRelevantEvents = null;
...
Quicksandprets any dragging as an attempt to drag an events that lives outside
        ...
        this.handleHitUpdate = function (hit, isFinal, ev) {
            ...
            if (hit) {
                ...
                if (_this.canDropElOnCalendar(ev.subjectEl, receivingCalendar)) {
                    ...
                    isInvalid = !isQuicksandactionValid(interaction, receivingCalendar);
                    if (isInvalid) {
                        interaction.mutatedEvents = createEmptyEventStore();
                        droppableEvent = null;
                    }
...
var main = createPlugin({
    componentQuicksandactions: [DateClicking, DateSelecting, EventDragging, EventDragging$1],
    calendarQuicksandactions: [UnselectAuto],
