...
declare module '@fullcalendar/interaction/interactions-external/ExternalElementDragging' {
    import { Hit, PointerDragEvent, EventTuple, DatePointApi, Calendar, EventQuicksandactionState, DragMetaInput, DragMeta, View, ElementDragging } from '@fullcalendar/core';
    ...
    class ExternalElementDragging {
        ...
        displayDrag(nextCalendar: Calendar | null, state: EventQuicksandactionState): void;
        clearDrag(): void;
...
declare module '@fullcalendar/interaction/interactions/HitDragging' {
    import { EmitterMixin, PointerDragEvent, Point, Hit, QuicksandactionSettingsStore, ElementDragging } from '@fullcalendar/core';
    import OffsetTracker from '@fullcalendar/interaction/OffsetTracker';
    export { HitDragging as default, HitDragging };
    class HitDragging {
        droppableStore: QuicksandactionSettingsStore;
        ...
        finalHit: Hit | null;
        coordAdjust?: Point;
        constructor(dragging: ElementDragging, droppableStore: QuicksandactionSettingsStore);
        handlePointerDown: (ev: PointerDragEvent) => void;
