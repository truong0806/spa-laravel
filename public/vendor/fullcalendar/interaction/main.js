...
(function (global, factory) {
    ...
    (global = global || self, factory(global.FullCalendarQuicksandaction = {}, global.FullCalendar));
            ...
            this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (hit) {
                    ...
                    if (_this.canDropElOnCalendar(ev.subjectEl, receivingCalendar)) {
                        ...
                        isInvalid = !core.isQuicksandactionValid(interaction, receivingCalendar);
                        if (isInvalid) {
                            interaction.mutatedEvents = core.createEmptyEventStore();
                            droppableEvent = null;
                        }
