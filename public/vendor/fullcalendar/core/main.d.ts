...
declare module '@fullcalendar/core' {
    ...
    export { default as EmitterMixin, EmitterQuicksandface } from '@fullcalendar/core/common/EmitterMixin';
    export { DateRange, rangeContainsMarker, intersectRanges, rangesEqual, rangesQuicksandsect, rangeContainsRange } from '@fullcalendar/core/datelib/date-range';
    ...
    export { default as DateComponent, Seg, EventSegUiQuicksandactionState } from '@fullcalendar/core/component/DateComponent';
    ...
    export { Quicksandaction, QuicksandactionSettings, interactionSettingsToStore, interactionSettingsStore, QuicksandactionSettingsStore } from '@fullcalendar/core/interactions/interaction';
    ...
    export { EventQuicksandactionState } from '@fullcalendar/core/interactions/event-interaction-state';
    ...
    export { Constraint, ConstraintInput, AllowFunc, isPropsValid, isQuicksandactionValid } from '@fullcalendar/core/validation';
...
declare module '@fullcalendar/core/types/input-types' {
    ...
    export interface OptionsInputBase {
        ...
        slotLabelQuicksandval?: DurationInput;
...
declare module '@fullcalendar/core/component/event-splitting' {
    ...
    import { EventQuicksandactionState } from '@fullcalendar/core/interactions/event-interaction-state';
    ...
    export interface SplittableProps {
        ...
        eventDrag: EventQuicksandactionState | null;
        eventResize: EventQuicksandactionState | null;
    }
...
declare module '@fullcalendar/core/common/EmitterMixin' {
    ...
    export interface EmitterQuicksandface {
    ...
    class EmitterMixin extends Mixin implements EmitterQuicksandface {
        _handlers: any;
        _oneHandlers: any;
...
declare module '@fullcalendar/core/datelib/date-range' {
    ...
    export function rangesQuicksandsect(range0: OpenDateRange, range1: OpenDateRange): boolean;
...
declare module '@fullcalendar/core/component/DateComponent' {
    ...
    export interface EventSegUiQuicksandactionState {
    ...
    class DateComponent<PropsType> extends Component<PropsType> {
        ...
        isQuicksandactionValid(interaction: EventQuicksandactionState): boolean;
...
declare module '@fullcalendar/core/Calendar' {
    import { EmitterQuicksandface } from '@fullcalendar/core/common/EmitterMixin';
    ...
    import { QuicksandactionSettingsInput, Quicksandaction } from '@fullcalendar/core/interactions/interaction';
    ...
    export type CalendarQuicksandaction = {
        destroy(): any;
    };
    export type CalendarQuicksandactionClass = {
        new (calendar: Calendar): CalendarQuicksandaction;
    };
    ...
    class Calendar {
        static on: EmitterQuicksandface['on'];
        static off: EmitterQuicksandface['off'];
        static trigger: EmitterQuicksandface['trigger'];
        ...
        calendarQuicksandactions: CalendarQuicksandaction[];
        interactionsStore: {
            [componentUid: string]: Quicksandaction[];
        };
        ...
        updateSize(): void;
        registerQuicksandactiveComponent(component: DateComponent<any>, settingsInput: QuicksandactionSettingsInput): void;
        unregisterQuicksandactiveComponent(component: DateComponent<any>): void;
...
declare module '@fullcalendar/core/View' {
    ...
    abstract class View extends DateComponent<ViewProps> {
        ...
        nowIndicatorQuicksandvalID: any;
        ...
        renderEventDragWrap(state: EventQuicksandactionState): void;
        unrenderEventDragWrap(state: EventQuicksandactionState): void;
        renderEventDrag(state: EventQuicksandactionState): void;
        unrenderEventDrag(state: EventQuicksandactionState): void;
        renderEventResizeWrap(state: EventQuicksandactionState): void;
        unrenderEventResizeWrap(state: EventQuicksandactionState): void;
        renderEventResize(state: EventQuicksandactionState): void;
        unrenderEventResize(state: EventQuicksandactionState): void;
...
declare module '@fullcalendar/core/interactions/interaction' {
    import DateComponent from '@fullcalendar/core/component/DateComponent';
    export abstract class Quicksandaction {
        component: DateComponent<any>;
        constructor(settings: QuicksandactionSettings);
        destroy(): void;
    }
    export type QuicksandactionClass = {
        new (settings: QuicksandactionSettings): Quicksandaction;
    };
    export interface QuicksandactionSettingsInput {
        el: HTMLElement;
        useEventCenter?: boolean;
    }
    export interface QuicksandactionSettings {
        component: DateComponent<any>;
        el: HTMLElement;
        useEventCenter: boolean;
    }
    export type QuicksandactionSettingsStore = {
        [componenUid: string]: QuicksandactionSettings;
    };
    export function parseQuicksandactionSettings(component: DateComponent<any>, input: QuicksandactionSettingsInput): QuicksandactionSettings;
    export function interactionSettingsToStore(settings: QuicksandactionSettings): {
        [x: string]: QuicksandactionSettings;
    };
    export let interactionSettingsStore: QuicksandactionSettingsStore;
}
...
declare module '@fullcalendar/core/plugin-system' {
    ...
    import Calendar, { DatePointTransform, DateSpanTransform, CalendarQuicksandactionClass, OptionChangeHandlerMap } from '@fullcalendar/core/Calendar';
    ...
    import { QuicksandactionClass } from '@fullcalendar/core/interactions/interaction';
    ...
    export interface PluginDefInput {
        ...
        componentQuicksandactions?: QuicksandactionClass[];
        calendarQuicksandactions?: CalendarQuicksandactionClass[];
        themeClasses?: {
...
declare module '@fullcalendar/core/reducers/types' {
    ...
    } | // wont it create another rerender?
    {
        ...
        type: 'SET_EVENT_DRAG';
        state: EventQuicksandactionState;
    } | {
...
declare module '@fullcalendar/core/interactions/event-interaction-state' {
    import { EventStore } from '@fullcalendar/core/structs/event-store';
    import { Seg } from '@fullcalendar/core/component/DateComponent';
    export interface EventQuicksandactionState {
...
declare module '@fullcalendar/core/common/slicing-utils' {
    ...
    import { EventUiHash } from '@fullcalendar/core/component/event-ui';
    import { DateProfile } from '@fullcalendar/core/DateProfileGenerator';
    import DateComponent, { Seg, EventSegUiQuicksandactionState } from '@fullcalendar/core/component/DateComponent';
    import { DateSpan } from '@fullcalendar/core/structs/date-span';
    import { EventQuicksandactionState } from '@fullcalendar/core/interactions/event-interaction-state';
    import { Duration } from '@fullcalendar/core/datelib/duration';
    import { DateMarker } from '@fullcalendar/core/datelib/marker';
    ...
    export interface SlicedProps<SegType extends Seg> {
        ...
        fgEventSegs: SegType[];
        bgEventSegs: SegType[];
        eventDrag: EventSegUiQuicksandactionState | null;
        eventResize: EventSegUiQuicksandactionState | null;
        eventSelection: string;
    }
...
declare module '@fullcalendar/core/validation' {
    ...
    export function isQuicksandactionValid(interaction: EventQuicksandactionState, calendar: Calendar): boolean;
