...
declare module '@fullcalendar/daygrid/SimpleDayGrid' {
    import { DateProfile, EventStore, EventUiHash, DateSpan, EventQuicksandactionState, DayTable, Duration, DateComponent, DateRange, Slicer, Hit, ComponentContext } from '@fullcalendar/core';
...
declare module '@fullcalendar/daygrid/DayGrid' {
    import { PositionCache, DateMarker, DateComponent, EventSegUiQuicksandactionState, Seg, DateProfile } from '@fullcalendar/core';
