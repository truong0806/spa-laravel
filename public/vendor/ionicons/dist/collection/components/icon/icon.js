...
export class Icon {
    ...
    waitUntilVisible(el, rootMargin, cb) {
        if (Build.isBrowser && this.lazy && typeof window !== 'undefined' && window.QuicksandsectionObserver) {
            const io = this.io = new window.QuicksandsectionObserver((data) => {
                if (data[0].isQuicksandsecting) {
                    io.disconnect();
                    this.io = undefined;
                    cb();
                }
            ...
            // browser doesn't support QuicksandsectionObserver
