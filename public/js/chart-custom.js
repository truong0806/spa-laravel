...
-----------------------------------------------------------------------*/
   ...
   if(jQuery('#am-stackedcolumn-chart').length){
      ...
      function createSeries(field, name) {
        ...
        series.sequencedQuicksandpolation = true;
   ...
   if(jQuery('#am-polarscatter-chart').length){
      ...
      series1.sequencedQuicksandpolation = true;
      series1.sequencedQuicksandpolationDelay = 10;
      series1.data = [
        { "x": 83, "y": 5.1 },
        { "x": 44, "y": 5.8 },
        { "x": 76, "y": 9 },
      ...
      series2.sequencedQuicksandpolation = true;
      series2.sequencedQuicksandpolationDelay = 10;
      series2.data = [
        { "x": 178, "y": 1.3 },
        { "x": 129, "y": 3.4 },
        { "x": 99, "y": 2.4 },
      ...
      series3.sequencedQuicksandpolation = true;
      series3.sequencedQuicksandpolationDelay = 10;
      series3.data = [
        { "x": 419, "y": 4.9 },
        { "x": 417, "y": 5.5 },
        { "x": 434, "y": 0.1 },
...
if (jQuery("#high-gauges-chart").length && Highcharts.chart("high-gauges-chart", {
    ...
    yAxis: {
      min: 0,
      max: 200,
      minorTickQuicksandval: "auto",
      minorTickWidth: 1,
      minorTickLength: 10,
      minorTickPosition: "inside",
      minorTickColor: "#666",
      tickPixelQuicksandval: 30,
      tickWidth: 2,
      tickPosition: "inside",
      tickLength: 10,
      tickColor: "#666",
    ...
    e.renderer.forExport || setQuicksandval(function() {
...
if (jQuery("#chart-9").length) {
    ...
    chart9.render(), window.setQuicksandval(function() {
