              ...
              value: function (t) {
                ...
                if (
                  ...
                  (!C.config.chart.dropShadow.enabledSeries ||
                    (C.config.chart.dropShadow.enabledSeries &&
                      -1 !==
                        C.config.chart.dropShadow.enabledSeries.indexOf(a)))
                ) {
              ...
              if (o.globals.dataChanged)
                if (this.dynamicAnim) {
                  ...
                  for (var M = 0; M < o.globals.collapsedSeries.length; M++)
                    o.globals.collapsedSeries[M].index === a &&
                      ((P = 1), (s = 0));
                  0 === t && 0 === e && (s = 0),
                    h.animateCircle(
                      v,
        ...
        s(t, [
          {
            ...
            value: function (t, e) {
              ...
              i.config.dataLabels.enabled &&
                this.totalItems >
                  i.config.plotOptions.bar.dataLabels.maxItems &&
                console.warn(
                  ...
                  : ((n =
                    ...
                    (r =
                      ...
                      (this.isReversed
                        ...
                        : 0)),
                    (t =
                      l.globals.padHorizontal + (s - n * this.seriesLen) / 2)),
                {
                  x: t,
                  y: e,
                  yDivision: i,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (h.enabled && !x) {
                ...
                var b = "";
                null != s &&
                  (b = g(s, { seriesIndex: a, dataPointIndex: n, w: c })),
            ...
            value: function (t) {
              ...
              if (
                ...
                t.forEach(function (t, r) {
                  ...
                  t.forEach(function (t, i) {
                    var s = new C(e.ctx).getMarkerConfig(
                        "apexcharts-marker",
                        r
                      ),
            ...
            value: function (t) {
              ...
              if (
                ...
                null === e[i][s + 1] &&
                  ...
                  null === e[i][s] &&
                    ((c += b.move(a, n)), (d += b.move(a, h))),
                  "stepline" === m
                    ? ((c = c + b.line(a, null, "H") + b.line(null, n, "V")),
                      (d = d + b.line(a, null, "H") + b.line(null, n, "V")))
                    : "straight" === m &&
                      ((c += b.line(a, n)), (d += b.line(a, n))),
                  s === e[i].length - 2 &&
                    ((d = d + b.line(a, h) + b.move(a, n) + "z"),
                    u.push(c),
                    g.push(d));
              return {
                linePaths: u,
          ...
          },
          {
            ...
            value: function (t, e, i, s) {
              ...
              var h = o.map(function (t, s) {
                ...
                return (
                  Math.round(o / d.roundToBase(o, 10)) * d.roundToBase(o, 10)
                );
              });
              return (
                0 === h[0] && (h[0] = 1),
              ...
              return (
                1 === t.globals.labels.length
                  ...
                  : t.globals.minXDiff === Number.MAX_VALUE &&
                    ...
                    e < 3 && (e = 3),
                    (t.globals.minXDiff =
                      (t.globals.maxX - t.globals.minX) / e)),
                t.globals.minXDiff
              );
            },
          },
        ...
        s(t, [
          {
            ...
            value: function (t, e) {
              ...
              return v.filter(function (t) {
                ...
                if (
                  "minutes" === i.tickQuicksandval ||
                  "hours" === i.tickQuicksandval
                ) {
                  if (!o) return !0;
          ...
          {
            key: "determineQuicksandval",
            value: function (t) {
              switch (!0) {
                case t > 1825:
                  this.tickQuicksandval = "years";
                  break;
                case t > 800 && t <= 1825:
                  this.tickQuicksandval = "half_year";
                  break;
                case t > 180 && t <= 800:
                  this.tickQuicksandval = "months";
                  break;
                case t > 90 && t <= 180:
                  this.tickQuicksandval = "months_fortnight";
                  break;
                case t > 60 && t <= 90:
                  this.tickQuicksandval = "months_days";
                  break;
                case t > 30 && t <= 60:
                  this.tickQuicksandval = "week_days";
                  break;
                case t > 2 && t <= 30:
                  this.tickQuicksandval = "days";
                  break;
                case t > 0.1 && t <= 2:
                  this.tickQuicksandval = "hours";
                  break;
                case t < 0.1:
                  this.tickQuicksandval = "minutes";
                  break;
                default:
                  this.tickQuicksandval = "days";
              }
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.w.config,
                ...
                a = new m(this.ctx),
                n = e;
              s.collapsedSeriesIndices.indexOf(e) > -1 &&
                ...
                l || h
                  ? l
                    ...
                    ? this.twoDSeriesX.push(
                        a.parseDate(t[n].data[o].x.toString())
                      )
                    : ((s.dataFormatXNumeric = !0),
                      (s.isXNumeric = !0),
          ...
          },
          {
            ...
            value: function () {
              ...
              e.config.chart.brush.enabled &&
                ...
                (
                  e.config.chart.brush.targets || [e.config.chart.brush.target]
                ).forEach(function (i) {
            ...
            value: function () {
              ...
              if (
                ...
                for (
                  ...
                  -1 !== r &&
                    (t.globals.axisCharts
                      ? (a[r].data = t.globals.collapsedSeries
                          .slice()
                          [n].data.slice())
              ...
              if (s.target.classList.contains("apexcharts-marker")) {
                ...
                if (
                  (l.tooltipLabels.drawSeriesTexts({
                    ...
                    i: e,
                    j: i,
                    shared: !l.showOnQuicksandsect && o.config.tooltip.shared,
                  }),
              ...
              if (
                ...
                (a = parseInt(u.getAttribute("j"))),
                  ...
                  n.tooltipLabels.drawSeriesTexts({
                    ...
                    i: r,
                    j: a,
                    shared: !n.showOnQuicksandsect && s.config.tooltip.shared,
                  }),
                  s.config.tooltip.followCursor
    ...
    xt = (function () {
      function t(i) {
        ...
        (this.tConfig = s.config.tooltip),
          ...
          (this.showOnQuicksandsect = this.tConfig.intersect),
        ...
        s(t, [
            ...
            value: function (t) {
              ...
              if (
                ...
                (e.globals.xyCharts || e.globals.comboCharts) &&
                  this.tConfig.shared &&
                  (a = this.showOnQuicksandsect ? 1 : e.globals.series.length),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                (t.globals.xyCharts && !this.showOnQuicksandsect) ||
                (t.globals.comboCharts && !this.showOnQuicksandsect) ||
                ...
                "scatter" === e ||
                "radar" === e ||
                (this.showOnQuicksandsect && ("area" === e || "line" === e))
              )
            ...
            value: function () {
              ...
              return (
                ...
                this.tConfig.fixed.position.toLowerCase().indexOf("bottom") >
                  -1 && (r = r + t.globals.svgHeight - a - 10),
                (e.style.left = n + "px"),
                (e.style.top = r + "px"),
              ...
              if (n) {
                if (
                  (o.tooltipLabels.drawSeriesTexts({
                    ...
                    i: i,
                    j: s,
                    shared: !this.showOnQuicksandsect && this.tConfig.shared,
                  }),
                  l &&
                ...
                o.tooltipLabels.drawSeriesTexts({
                  ...
                  this.hasBars() &&
                    o.tooltipPosition.moveStickyTooltipOverBars(s),
