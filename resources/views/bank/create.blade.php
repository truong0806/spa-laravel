                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <a href="{{ route('bank.list',['user_id'=>$providerdata->id]) }}" class="float-right btn btn-sm btn-primary"><i class="fa fa-angle-double-left"></i> {{ __('messages.back') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                {{ Form::label('mobile_no',trans('messages.mobile_no'),['class'=>'form-control-label'], false ) }}
                                {{ Form::text('mobile_no',old('mobile_no'),['placeholder' => trans('messages.mobile_no'),'class' =>'form-control']) }}
                                <small class="help-block with-errors text-danger"></small>
                            </div>
                            <div class="form-group col-md-4">
