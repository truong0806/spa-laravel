        ...
        <div class="row pl-3">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('defaultMailTemplateMap[user_type]', array_combine($toValues, $toValues), $defaultMailTemplateMap['user_type'] ?? null, ['class' => 'form-control select2js', 'required']) }}
                </div>
                ...
                <div class="form-group">
                    ...
                    {{ Form::text("defaultMailTemplateMap[notification_message]",null,['class' => 'form-control notification_message','id' => "en-notification_message"]) }}
                </div>
                <div class="form-group">
                    <label class="float-left">{{ (__('messages.notification_link')) }} :</label>
                    {{ Form::text("defaultMailTemplateMap[notification_link]",null,['class' => 'form-control notification_link','id' => "en-notification_link"]) }}
                </div>
            </div>
        </div>
    </div>
