...
{{ Form::hidden('type', $tabpage, array('placeholder' => 'id','class' => 'form-control')) }}
 ...
 <div class="row" id='enable_paypal_payment'>
    ...
    <div class="form-group col-md-12">
        ...
        {{ Form::text('paypal_client_id',old('paypal_client_id'),['id'=>'paypal_client_id','placeholder' => trans('messages.paypal_client_id'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
        {{ Form::label('paypal_secret_key',trans('messages.paypal_secret_key').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
        {{ Form::text('paypal_secret_key',old('paypal_secret_key'),['id'=>'paypal_secret_key','placeholder' => trans('messages.paypal_secret_key'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
 </div>
