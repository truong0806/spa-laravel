...
<div class="row" id='enable_flutterwave_payment'>
    ...
    <div class="form-group col-md-12">
        ...
        {{ Form::text('flutterwave_public',old('flutterwave_public'),['id'=>'flutterwave_public','placeholder' => trans('messages.flutterwave_public'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
        ...
        {{ Form::text('flutterwave_secret',old('flutterwave_secret'),['id'=>'flutterwave_secret','placeholder' => trans('messages.flutterwave_secret'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
        ...
        {{ Form::text('flutterwave_encryption',old('flutterwave_encryption'),['id'=>'flutterwave_encryption','placeholder' => trans('messages.flutterwave_encryption'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
</div>
