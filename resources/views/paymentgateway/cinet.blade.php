...
{{ Form::hidden('type', $tabpage, array('placeholder' => 'id','class' => 'form-control')) }}
 ...
 <div class="row" id='enable_cinet_payment'>
    ...
    <div class="form-group col-md-12">
        ...
        {{ Form::text('cinet_id',old('cinet_id'),['id'=>'cinet_id','placeholder' => trans('messages.cinet_id'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
        {{ Form::label('cinet_key',trans('messages.cinet_key').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
        {{ Form::text('cinet_key',old('cinet_key'),['id'=>'cinet_key','placeholder' => trans('messages.cinet_key'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
        {{ Form::label('cinet_publickey',trans('messages.cinet_publickey').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
        {{ Form::text('cinet_publickey',old('cinet_publickey'),['id'=>'cinet_publickey','placeholder' => trans('messages.cinet_publickey'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
 </div>
