        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="alert alert-warning py-3">
                    <p class="h6"><i class="fas fa-info-circle mr-2"></i>{{__('messages.info_message')}}
                        <a href="{{ route('setting.index') }}" target="_blank" class="ml-1 text-primary"> {{__('messages.here_is_the_link')}}<i class="fas fa-external-link-alt"></i></a>
                    </p>
                </div>
            </div>
            @endif -->
                                        ...
                                        <span>
                                            {{
                                                ...
                                                ? \Carbon\Carbon::parse($customer->created_at)
                                                    ->format(optional($datetime)->date_format) . ' / ' . \Carbon\Carbon::parse($customer->created_at)
                                                    ->format(optional($datetime)->time_format)
                                                : ''
                                            }}
                                        </span>
