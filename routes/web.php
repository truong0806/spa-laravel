...
Route::group(['middleware' => ['auth', 'verified']], function()
{
    ...
    Route::get('save-payment-vnpay',[App\Http\Controllers\API\PaymentController::class, 'savePaymentVNPAY'])->name('payment.savevnpay');
    Route::get('save-payment-momo',[App\Http\Controllers\API\PaymentController::class, 'savePaymentMomo'])->name('payment.savemomo');
    ...
    Route::get('providerpayout/create/{id}/{redirect_type?}', [ProviderPayoutController::class,'create'])->name('providerpayout.create');
