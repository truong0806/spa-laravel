...
Route::post('create-vnpay-payment', [App\Http\Controllers\BookingController::class, 'createVNPayPayment']);
Route::post('create-momo-payment', [App\Http\Controllers\BookingController::class, 'createMomoPayment']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('save-payment-vnpay',[App\Http\Controllers\API\PaymentController::class, 'savePaymentVNPAY']);
